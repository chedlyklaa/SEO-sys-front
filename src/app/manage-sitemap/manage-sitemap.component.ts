...
//pop up modification 
isPopoverOpen = false;
BaseLink='Ijeni Tous services! | Trouvez des prestataires qualifiés'
BaseDiscription="Ijeni Le service qu'il vous faut en une minute chrono!. Trouvez des prestataires qualifiés pour tous vos besoins de service en Tunisie."
ogImage : string = "";
ogTitle: string = "";
